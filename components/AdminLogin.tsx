...
const AdminLogin: React.FC = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
      <h2 className="text-3xl font-bold font-serif text-center text-brand-text dark:text-gray-100 mb-6">Admin Login</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-brand-dark-pink bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200"
            required
            autoComplete="email"
          />
        </div>
